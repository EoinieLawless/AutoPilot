...
// Was Going to write the method to save to csv file here, but decided against it
//
//	private void saveGameResults() {
//        try (FileWriter writer = new FileWriter("GameResults.csv")) {
//  
//            writer.write("Game Data\n");
//
//         
//            for (byte[] bm : view.getModel()) {
//                for (byte b : bm) {
//                    writer.write(b + ",");
//                }
//                writer.write("\n");
//            }
//
//            System.out.println("Game data saved to GameResults.csv");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
	...
	public void keyPressed(KeyEvent e) {
        ...
        if (keyCode == KeyEvent.VK_S) { // Press "S" to restart
            view.reset(); // Reset the view and bail out
        } else if (keyCode == KeyEvent.VK_R) { // Press "R" to record game data
        	view.logData(view.sample(), view.getLastMove()); // Save game data to txt
        } else { // Handle plane movement
